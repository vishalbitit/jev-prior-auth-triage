...
- TypeSafe-reported performance figures (latency range, cost multipliers) shown in the dashboard are clearly labeled as TypeSafe's own published claims, distinct from the numbers we measured ourselves.
